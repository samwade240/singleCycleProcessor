	...
	*/
    ...
    for (address=0; readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2);
	    ...
	    if (!strcmp(opcode, "add")) {
	        num = (ADD << 26) | (atoi(arg0) << 21) | (atoi(arg1) << 16);
		        //| atoi(arg2);
	    } else if (!strcmp(opcode, "and")) {
	        num = (NAND << 26) | (atoi(arg0) << 21) | (atoi(arg1) << 16);
		        //| atoi(arg2);
	    } else if (!strcmp(opcode, "cmp")) {
	        num = (CMP  << 26) | (atoi(arg0) << 21) | (atoi(arg1) << 16);
		        //| atoi(arg2);
...
int translate_load_word() {
    ...
    return (MOVL << 26) | (base_reg << 16) |	(dest_reg << 21) | address_field;
}
...
int translate_save_word() {
    ...
    return (MOVS << 26) | (base_reg << 16) |	(dest_reg << 21) | address_field;
}
